% This script implements Principal Component Analysis
...
num_of_dimensions_labels=[5,10,20,30,45];
...
for num_of_dimensions=num_of_dimensions_labels
    ...
    [mappedX, mapping] = pca(data_without_labels', num_of_dimensions);
...
title('k-Fold Cross Validation Accuracy after PCA');
